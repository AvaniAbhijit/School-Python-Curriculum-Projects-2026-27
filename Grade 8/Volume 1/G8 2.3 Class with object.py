...
# Task 2: Create Your Own Class with an  Object
#       1. Create a class named Sport
#       2. Create a function show_message() and Print “Welcome to Sports Academy”
#       3. Create an object and call the function

class Pizza:                             # Create a class named Pizza (this is a blueprint)

    def show_message(self):                  # Define a function inside the class
