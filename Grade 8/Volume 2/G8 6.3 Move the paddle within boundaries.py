...
# Check lower boundary movement of paddle:
# self.rect.bottom < screen_height, checks paddle doesn't move down beyond the
# screen height on line 44
# 'and' is a logical operator in Python, which checks both the conditions.

# Task: Check paddle doesn't move up beyond the margin line on line 42 by
#       using the self.rect.top of the paddle.
