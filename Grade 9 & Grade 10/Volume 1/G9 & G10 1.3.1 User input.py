...
name = input("Enter your name: ")  # input() stores user data as STRING (text)
print("Hello", name)               # The value is stored exactly as typed
print(type(name))                  # Show the type of data stored
